module.exports = function(CaseCases) {
     ...
     */
    CaseCases.getDuplicates = function(cb) {
        var collection = CaseCases.getDataSource().connector.collection('caseCases')
        collection.aggregate([{
                    '$group': {
                        '_id': { 'caseId': '$caseId', 'caseReferedToId': '$caseReferedToId' },
