...
.controller('CasesController',function ($scope, $timeout, Court, Case, Legislation, CaseLegislations, CaseCases, CaseWorks, AreaOfLaw,Jurisdiction, Location, baseURL, filterFilter) {
    console.log("xxx---->");
         ...
         $scope.saveLegislationStab = function(event){
           console.info("Event is ", event.which);
            if(event.which === 188){
              Legislation.upsert($scope.legislationStab,
                  function(legislation){
                    $scope.legislations.push(legislation);
