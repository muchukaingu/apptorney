  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use AreaOfLaw.cases.findById() instead.
        "prototype$__findById__cases": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/areaOfLaws/:id/cases/:fk",
          method: "GET"
        },

        // INTERNAL. Use AreaOfLaw.cases.destroyById() instead.
        ...
        // INTERNAL. Use AreaOfLaw.cases.updateById() instead.
        ...
        // INTERNAL. Use AreaOfLaw.cases() instead.
        "prototype$__get__cases": {
          isArray: true,
          url: urlBase + "/areaOfLaws/:id/cases",
          method: "GET"
        },

        // INTERNAL. Use AreaOfLaw.cases.create() instead.
        "prototype$__create__cases": {
          url: urlBase + "/areaOfLaws/:id/cases",
          method: "POST"
        },

        // INTERNAL. Use AreaOfLaw.cases.destroyAll() instead.
        "prototype$__delete__cases": {
          url: urlBase + "/areaOfLaws/:id/cases",
          method: "DELETE"
        },

        // INTERNAL. Use AreaOfLaw.cases.count() instead.
        "prototype$__count__cases": {
          url: urlBase + "/areaOfLaws/:id/cases/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name apiServices.AreaOfLaw.cases
     * @header apiServices.AreaOfLaw.cases
     * @object
     * @description
     *
     * The object `AreaOfLaw.cases` groups methods
     * manipulating `Case` instances related to `AreaOfLaw`.
     *
     * Call {@link apiServices.AreaOfLaw#cases AreaOfLaw.cases()}
     * to query all related instances.
     */
        ...
        R.cases = function() {
          ...
          var action = TargetResource["::get::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name apiServices.AreaOfLaw.cases#count
         * @methodOf apiServices.AreaOfLaw.cases
         *
         * @description
         *
         * Counts cases of areaOfLaw.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.cases.count = function() {
          var TargetResource = $injector.get("Case");
          var action = TargetResource["::count::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name apiServices.AreaOfLaw.cases#create
         * @methodOf apiServices.AreaOfLaw.cases
         *
         * @description
         *
        ...
        R.cases.create = function() {
          var TargetResource = $injector.get("Case");
          var action = TargetResource["::create::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name apiServices.AreaOfLaw.cases#createMany
         * @methodOf apiServices.AreaOfLaw.cases
         *
         * @description
         *
        ...
        R.cases.createMany = function() {
          var TargetResource = $injector.get("Case");
          var action = TargetResource["::createMany::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name apiServices.AreaOfLaw.cases#destroyAll
         * @methodOf apiServices.AreaOfLaw.cases
         *
         * @description
         *
        ...
        R.cases.destroyAll = function() {
          var TargetResource = $injector.get("Case");
          var action = TargetResource["::delete::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name apiServices.AreaOfLaw.cases#destroyById
         * @methodOf apiServices.AreaOfLaw.cases
         *
         * @description
         *
        ...
        R.cases.destroyById = function() {
          var TargetResource = $injector.get("Case");
          var action = TargetResource["::destroyById::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name apiServices.AreaOfLaw.cases#findById
         * @methodOf apiServices.AreaOfLaw.cases
         *
         * @description
         *
        ...
        R.cases.findById = function() {
          var TargetResource = $injector.get("Case");
          var action = TargetResource["::findById::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name apiServices.AreaOfLaw.cases#updateById
         * @methodOf apiServices.AreaOfLaw.cases
         *
         * @description
         *
        ...
        R.cases.updateById = function() {
          var TargetResource = $injector.get("Case");
          var action = TargetResource["::updateById::areaOfLaw::cases"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use AreaOfLaw.cases.create() instead.
        "::create::areaOfLaw::cases": {
          url: urlBase + "/areaOfLaws/:id/cases",
          method: "POST"
        },

        // INTERNAL. Use AreaOfLaw.cases.createMany() instead.
        "::createMany::areaOfLaw::cases": {
          isArray: true,
          url: urlBase + "/areaOfLaws/:id/cases",
          method: "POST"
        },
        ...
        // INTERNAL. Use AreaOfLaw.cases.destroyAll() instead.
        "::delete::areaOfLaw::cases": {
          url: urlBase + "/areaOfLaws/:id/cases",
          method: "DELETE"
        },

        // INTERNAL. Use AreaOfLaw.cases.count() instead.
        "::count::areaOfLaw::cases": {
          url: urlBase + "/areaOfLaws/:id/cases/count",
          method: "GET"
        },
