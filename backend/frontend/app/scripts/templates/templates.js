angular.module('theme.templates', []).run(['$templateCache', function ($templateCache) {
  ...
  $templateCache.put('templates/legislation-modal.html',
    ...
    "\n" +
    "                    <div class=\"col-xs-12 col-md-6 form-group\">\n" +
    "                      <input id=\"dateOfAssent\" name=\"dateOfAssent\" type=\"text\" class=\"form-control\" ng-model=\"legislation.dateOfAssent\" ng-minlength=2 ng-focus required placeholder=\"Date of Assent (dd-mm-yyyy) *\"/>\n" +
