...
class AgreementDetailsVC: UITableViewController {
    ...
    func configureUIControls () { //for cutomising controls on the UI
        ...
        if #available(iOS 11.0, *) {
            ...
            self.title = legislationInstance.legislationName
...
extension AgreementDetailsVC: HeaderViewDelegate {
...
extension AgreementDetailsVC: UISearchBarDelegate {
