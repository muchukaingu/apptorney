...
class SearchVC: UITableViewController, UISearchResultsUpdating, UISearchBarDelegate, ErrorViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //self.configureUIControls()  //UI Customisation for UISearchController and UINavController
