...
angular.module('theme.dashboard', [])
    .controller('DashboardController', ['$scope', 'Appuser', 'Legislation', 'Dashboard', function($scope, Appuser, Legislation, Dashboard) {
        ...
        $scope.plotGrowthData = [{
            data: [],
            label: "Increase in Users"
        }];
        Dashboard.summary(function(res) {
            console.info(res.data);
            $scope.summary = res.data.summary;

            $scope.plotStatsData = [{
                data: res.data.summary.userStats,
                label: "Registered Users"
            }];

            $scope.plotGrowthData = [{
                data: res.data.summary.userGrowth,
                label: "Increase in Users"
            }];
